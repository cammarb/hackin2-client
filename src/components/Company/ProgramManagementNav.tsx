    ...
    <nav style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #e1e4e8' }}>
      <ul style={{ display: 'flex', justifyContent: 'flex-end', listStyle: 'none', margin: 0, padding: '8px 16px' }}>
        <li style={{ margin: '0 8px' }}>
          <NavLink to="/program-management/submissions" style={{ color: '#586069', textDecoration: 'none', fontSize: '14px' }} activeClassName="font-bold">Submissions</NavLink>
        </li>
        <li style={{ margin: '0 8px' }}>
          <NavLink to="/program-management/details" style={{ color: '#586069', textDecoration: 'none', fontSize: '14px' }} activeClassName="font-bold">Details</NavLink>
        </li>
        <li style={{ margin: '0 8px' }}>
          <NavLink to="/program-management/userrolespermissions" style={{ color: '#586069', textDecoration: 'none', fontSize: '14px' }} activeClassName="font-bold">User Roles and Permissions</NavLink>
        </li>
        {/* Dropdown */}
        <li style={{ margin: '0 8px' }}>
          {/* Dropdown Trigger */}
